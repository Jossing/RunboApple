 ...
 * {@link RightFragment.Listener} interface
 * to handle interaction events.
 * Use the {@link RightFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RightFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static RightFragment newInstance(int page) {
    ...
    private void initWidget() {
        ...
        adapter = new OrdersAdapter(getActivity(), "seller");
        rvMyOrders = (RecyclerView) rootView.findViewById(R.id.rv_my_orders_right);
    ...
    public void onRefresh() {
        if (refreshLayout.isRefreshing()) {
            ((MyOrderActivity)getActivity()).queryOrders("seller");
        }
    }
    ...
    public interface Listener {
        ...
        // void onRightQueryOrdersDone(List<Order> orders);
    }
}
