...
public class ColourLineView extends View {
    ...
    public void initAttr(Context context, AttributeSet attrs){
        ...
        lean_degree = typedArray.getDimension(R.styleable.ColourLineView_lean_degree, 8);
        ...
        third_color = typedArray.getColor(R.styleable.ColourLineView_third_color,Color.YELLOW);
